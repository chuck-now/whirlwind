...
namespace BaseLib.Runtime.Validation.Interception
{
    ...
    public class MethodInvocationValidator : ITransientDependency
    {
        ...
        protected virtual void CheckInitialized()
        {
            if (Method == null)
            {
                throw new BaseLibException("This object has not been initialized. Call Initialize method first.");
            }
        }
        ...
        {
            throw new BaseLibValidationException("方法参数是无效的！有关详细信息,请参阅ValidationErrors：", ValidationErrors);
        }
