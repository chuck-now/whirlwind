...
namespace BaseLib.Domain.Uow
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork, IActiveUnitOfWork, IUnitOfWorkCompleteHandle, IDisposable
    {
        ...
        private void PreventMultipleBegin()
        {
            ...
            {
                throw new BaseLibException("This unit of work has started before. Can not call Start method more than once.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new BaseLibException("Complete is called before!");
            }
        ...
        private DataFilterConfiguration GetFilter(string filterName)
        {
            ...
            {
                throw new BaseLibException("Unknown filter name: " + filterName + ". Be sure this filter is registered before.");
            }
