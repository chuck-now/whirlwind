...
namespace BaseLib.Domain.Uow
{
    ...
    public interface IActiveUnitOfWork
    {
        ...
        /// </summary>
        /// <param name="filterNames">One or more filter names. <see cref="BaseLibDataFilters"/> for standard filters.</param>
        ...
        /// </summary>
        /// <param name="filterName">Name of the filter. <see cref="BaseLibDataFilters"/> for standard filters.</param>
