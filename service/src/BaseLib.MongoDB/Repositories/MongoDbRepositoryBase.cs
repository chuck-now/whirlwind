...
namespace BaseLib.MongoDb.Repositories
{
    /// <summary>
    /// MongoDB Repository
    /// </summary>
    ...
    public abstract class MongoDbRepositoryBase<TEntity, TPrimaryKey> : BaseLibRepositoryBase<TEntity, TPrimaryKey> where TEntity : class, IEntity<TPrimaryKey>
    {
